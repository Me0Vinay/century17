...
function renderProductDetail() {
    ...
    const whatsappUrl = CONFIG.whatsappNumber
        ? `https://wa.me/${CONFIG.whatsappNumber}?text=${encodeURIComponent(`Hi! I'm interested in: ${currentProduct.name} (₹${currentProduct.price.toFixed(2)}). Please share more details.`)}`
        : '';
    ...
    const detailHTML = `
        <div class="product-detail-wrapper">
            ...
            <div class="product-info-detail">
                ...
                ${whatsappUrl ? `
                    <a href="${whatsappUrl}" target="_blank" rel="noopener" class="whatsapp-inquiry-btn">
